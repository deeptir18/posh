...
impl Parser {
    ...
    fn parse_invocation(
        ...
        let mut matches: clap::ArgMatches = match app.get_matches_from_safe(invocation_clone) {
            Ok(m) => m,
    ...
    /// * matches - clap::ArgMatches - the result of running clap over the original invocation
    ...
    fn default_parse(&mut self, mut invocation: Vec<String>) -> Result<ArgMatch> {
